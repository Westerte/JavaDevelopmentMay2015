...
public abstract class Component implements Iterable<Component>{
	...
	public abstract void setComponent(int index, Component component) throws LogicalException;
	public abstract void addComponent(Component component) throws LogicalException;
	public abstract void removeComponent(Component component) throws LogicalException;
